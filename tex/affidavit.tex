\iffalse
% Déclaration sur l'honneur pour une thèse en français (inverser les \if pour une thèse en anglais)
    ...
    % --- Manual edit (corrections) ---
    \begin{flushright}
    \includegraphics[width=120pt,height=40pt]{example-image-a}
    \end{flushright}
    % signature
    % --- end of edit ---
\fi
...
\iftrue
% Affidavit of Honour for english thesis (invert the \if for an English thesis)
